...
g_line16X1 = g_line16_1.X
g_line16Y1 = g_line16_1.Y
g_line16X2 = g_line16_2.X
g_line16Y2 = g_line16_2.Y
...
.if Options.ReportModuleSizes \ .echoln strformat("Clip module: {0:N0} bytes.", $-Code) \ .endif
.endmodule